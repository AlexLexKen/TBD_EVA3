...
DELIMITER ;
/*
insert into personas(nombre, apellido_pat, apellido_mat, fecha_nac) values('Irvin','Aguirre','Mendoza','2002-04-22');
insert into personas(nombre, apellido_pat, fecha_nac) values('Irvin','Aguirre','2002-04-22'); */